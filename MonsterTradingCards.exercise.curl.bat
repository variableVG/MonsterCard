...
curl -X POST http://localhost:10001/tradings --header "Content-Type: application/json" --header "Authorization: Basic kienboec-mtcgToken" -d "{\"Id\": \"644808c2-f87a-4600-b313-122b02322fd5\", \"CardToTrade\": \"1cb6ab86-bdb2-47e5-b6e4-68c5ab389334\", \"Type\": \"monster\", \"MinimumDamage\": 15}"
echo.
echo check trading deals
curl -X GET http://localhost:10001/tradings --header "Authorization: Basic kienboec-mtcgToken"
echo.
...
curl -X DELETE http://localhost:10001/tradings/644808c2-f87a-4600-b313-122b02322fd5 --header "Authorization: Basic kienboec-mtcgToken"
echo.
echo.
...
curl -X POST http://localhost:10001/tradings/644808c2-f87a-4600-b313-122b02322fd5 --header "Content-Type: application/json" --header "Authorization: Basic kienboec-mtcgToken" -d "\"4ec8b269-0dfa-4f97-809a-2c63fe2a0025\""
echo.
echo try to trade 
echo.
curl -X POST http://localhost:10001/tradings/644808c2-f87a-4600-b313-122b02322fd5 --header "Content-Type: application/json" --header "Authorization: Basic altenhof-mtcgToken" -d "\"951e886a-0fbf-425d-8df5-af2ee4830d85\""
echo.
curl -X GET http://localhost:10001/tradings --header "Authorization: Basic kienboec-mtcgToken"
echo.
curl -X GET http://localhost:10001/tradings --header "Authorization: Basic altenhof-mtcgToken"
...
REM --------------------------------------------------
echo 22) Mandatory Unique Feature: The user can check its coins and sell a Card /for 5 coins.
curl -X GET http://localhost:10001/coins --header "Authorization: Basic kienboec-mtcgToken"
curl -X POST http://localhost:10001/sell --header "Content-Type: application/json" --header "Authorization: Basic kienboec-mtcgToken" -d "\"4ec8b269-0dfa-4f97-809a-2c63fe2a0025\""
echo.
echo end...
